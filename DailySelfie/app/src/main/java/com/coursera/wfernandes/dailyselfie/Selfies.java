...
public class Selfies extends Activity {
...
//            mImageView.setImageBitmap(imageThumbnail);
    ...
    private void createPendingIntents(){
        ...
        mSelfieNotificationIntent = new Intent(Selfies.this, SelfieNotificationReceiver.class);
        mSelfiePendingIntent = PendingIntent.getBroadcast(Selfies.this, 0, mSelfieNotificationIntent, 0);
    }
